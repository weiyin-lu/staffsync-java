...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='权限信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ss_role_permission_relevance` VALUES (1,'*','*','0'),(2,'employee','info.update','0'),(3,'engineer','admin.role.*','0'),(4,'engineer','admin.dept.*','0');
...
INSERT INTO `ss_user` VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3','0'),(8,'test1','e10adc3949ba59abbe56e057f20f883e','0'),(9,'test2','e10adc3949ba59abbe56e057f20f883e','0'),(11,'test3','e10adc3949ba59abbe56e057f20f883e','0');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户个人信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ss_user_info` VALUES (1,'admin','','12345678911','0',NULL,NULL,'weiyin2002@outlook.com'),(2,'test1','guest',NULL,'',NULL,NULL,NULL),(3,'test2','guest',NULL,'0',NULL,NULL,NULL),(4,'test3','guest',NULL,'0',NULL,NULL,NULL);
...
-- Dump completed on 2023-11-07 23:03:14
