...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='权限信息表';
...
INSERT INTO `ss_permission` VALUES (1,'*','全部权限','0');
...
INSERT INTO `ss_role` VALUES (1,'admin','超级管理员','0'),(2,'engineer','运维工程师','0'),(3,'guest','基础用户组','0');
...
CREATE TABLE `ss_role_permission_relevance` (
  ...
  PRIMARY KEY (`row_key`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色-权限关联关系';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ss_role_permission_relevance` VALUES (1,'admin','*','0');
...
INSERT INTO `ss_user_role_relevance` VALUES (1,'admin','admin','0'),(2,'admin','guest','');
...
-- Dump completed on 2023-11-04 19:47:05
